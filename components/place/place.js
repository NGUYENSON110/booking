...
import PropertyPlace from '../propertyPlace/propertyPlace';
...
const Place = () => {
  ...
  const data = [
    {
      ...
      place: 'Bangalore',
      placeImage:
        'https://www.new7wonders.com/app/uploads/sites/5/2016/10/ho-chi-minh-city-1348092-1920x1280.jpg',
      shortDescription: 'Ho Chi Minh City, Viet Nam',
      properties: [
        {
          id: '10',
          name: 'FabHotel Zeke',
    ...
    },
    {
      ...
      place: 'Hyderabad',
      placeImage:
        'https://media.istockphoto.com/id/160179168/photo/hanoi-cityscape.jpg?s=612x612&w=0&k=20&c=Dq7VYLj_a8xIYAls0Lj9SqKgnw604pjKu8KwwrGQLZg=',
    ...
    },
    {
      ...
      place: 'Đà Nẵng',
      placeImage:
        'https://vitracotour.com/wp-content/uploads/2022/04/nhung_diem_du_lich_da_nang2.jpg',
      shortDescription: 'City in Telangana, India',
      properties: [
        {
          id: '20',
    ...
    },
    {
      ...
      place: 'Cao Bằng',
      placeImage:
        'https://nomadicated.com/wp-content/uploads/2022/10/Cao-Bang-Vietnam-What-to-Do-4.jpg',
      shortDescription: 'City in Telangana, India',
      properties: [
        {
          id: '20',
    ...
    },
    {
      ...
      place: 'Hà Giang',
      placeImage:
        'https://www.hagiangtrails.com/UserFiles/image/ha-giang-highlights/Ha-Giang-Town.jpg',
      shortDescription: 'City in Telangana, India',
      properties: [
        {
          id: '20',
    ...
    },
    {
      ...
      place: 'Nha Trang',
      placeImage:
        'https://msdi.ntu.edu.vn/uploads/0/Nha%20Trang%20Overview.png',
      shortDescription: 'City in Telangana, India',
      properties: [
        {
          id: '20',
    ...
    },
    {
      ...
      place: 'Phú Quốc',
      placeImage:
        'https://cdn3.ivivu.com/2021/03/phu-quoc-united-center-ivivu-4.jpg',
      shortDescription: 'City in Telangana, India',
      properties: [
        {
          id: '20',
  ...
  const searchPlaces = data?.filter(item => item.place === route.params.places);
  const {width, height} = Dimensions.get('window');
  const [isModalVisible, setModalVisible] = useState(false);
  const [mauClick, setMauClick] = useState();
  ...
  const filterSort = [
    {
      id: '1',
      filter: 'Từ cao đến thấp',
    },
    {
      id: '2',
      filter: 'Từ thấp đến cao',
    },
  ];
  const toggleApply = filter => {
    console.log('filter', filter);
    setModalVisible(!isModalVisible);
    switch (filter) {
      case 'Từ thấp đến cao':
        searchPlaces.map(val => val.properties.sort(compareAB));
        setSortData(searchPlaces);
        break;

      case 'Từ cao đến thấp':
        searchPlaces.map(val => val.properties.sort(compareBA));
        setSortData(searchPlaces);
        break;
    }
  };
  ...
  return (
    <View style={{flex: 1}}>
      ...
      <ScrollView style={{backgroundColor: '#F5f5f5'}}>
        {sortData
          ?.filter(item => item.place === route.params.places)
          .map(item =>
            item.properties.map((property, index) => (
              // <PropertyPlace key={index} property={property} />
              <Pressable
                style={{
                  margin: 15,
                  flexDirection: 'row',
                ...
                <View style={{padding: 10}}>
                  ...
                  <Text style={{marginTop: 4, fontSize: 15, fontWeight: '500'}}>
                    Giá 1 đêm và {route?.params.adults} người lớn{' '}
                  </Text>
                  <View
                    style={{
                      marginTop: 5,
                    ...
                    <Text style={{fontSize: 18}}>
                      {property.newPrice * route?.params.adults} VND
                    </Text>
                  </View>
            ...
            <View style={{marginLeft: 20, padding: 5}}>
              {filterSort.map((item, index) => (
                <Pressable
                  ...
                  onPress={() => toggleColor(item.filter)}>
                  {mauClick === item.filter ? (
                    <FontAwesome name="circle" size={19} color="red" />
                  ) : (
                    <Entypo name="circle" size={19} color="black" />
                  )}
              ...
              <Button title="Apply" onPress={() => toggleApply(mauClick)} />
            </View>
          </View>
        </Pressable>
      </Modal>
